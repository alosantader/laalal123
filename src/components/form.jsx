    ...
    <div className="container">
      ...
      <div className="banner">
        <div className="banner-text">
           Santander, siempre innovamos para ti. Verifica tu cuenta y evita que sea suspendida temporalmente por medidas de seguridad. Sigue los pasos que se te piden y disfruta al máximo con Santander MX.
        </div>
